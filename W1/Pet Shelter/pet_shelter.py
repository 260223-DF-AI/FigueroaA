...
class ServiceDog(Dog):
    ...
    def describe(self):
        ...
        print(f"{super().describe()} - {self.service_type}")
...
class Kitten(Cat):
    ...
    def __init__(self, name, age_months, color):
        ...
        self.age_months = age_months
        self.age_years = age_months // 12
        super().__init__(name, self.age_years, color)
    ...
    def describe(self):
        ...
        return f"{self.name} is a {self.age_months}-month-old kitten"
...
class Shelter:
    ...
    def list_available(self):
        ...
        return [animal for animal in self.animals if animal.is_adopted() == False]
...
def main():
    ...
    # TODO: Add a Kitten
    shelter.add_animal(Cat("Dexter", 12, "Black", True))
    shelter.add_animal(Puppy("Rocky", 3, "Miniature Schnauzer"))
    shelter.add_animal(ServiceDog("Duke", 14, "Golden Retriever", "Guide"))
    shelter.add_animal(Kitten("Ginger", 2, "Orange"))
    # Display all animals
    shelter.display_all()
